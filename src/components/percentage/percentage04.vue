<template>
  <md-card class="m-1">
    <md-card-header>
      ...
      <div class="md-title md-display-1"> Calculadora De Porcentagem 04</div>
...
export default {
  ...
  computed: {
    result: function(){
      if(this.variables){
        return mainService.currencyFormat(((this.variables.value1 - this.variables.value2) / this.variables.value1) * 100)
      }
      return 0
    }
  },
